...
export TZ="JST-9"
export PATH="~/bin:/usr/lib/ccache/bin:/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin:/opt/java/jre/bin:${PATH}"
export EDITOR="vim"
...
alias urxvt="~/bin/urxvtc-start.sh"
...
export PERL5LIB="~/perl5/lib/perl5/x86_64-linux-thread-multi:~/perl5/lib/perl5";
